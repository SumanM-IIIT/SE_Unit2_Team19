				...
				if (bowlerIterator.hasNext()) {
					...
					if (frameNumber == 9){
						...
						try{
							...
							String dateString = "" + calendar.get(Calendar.HOUR_OF_DAY) + ":" + calendar.get(Calendar.MINUTE) + " " + Integer.toString(Integer.valueOf(calendar.get(Calendar.MONTH))+1) + "/" + calendar.get(Calendar.DAY_OF_MONTH) + "/" + (calendar.get(Calendar.YEAR));int finalscore=currentCumulScores.getFinalScore();
